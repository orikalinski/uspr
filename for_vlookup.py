...
csvfile_lookup = '/Users/amirgavrieli/PycharmProjects/Weizmann - scraper/uspr-master/ratings/Daw_jones_30/After_price_change/CVX_lookup.csv'
...
real_cvx_price_lookup = '/Users/amirgavrieli/PycharmProjects/Weizmann - scraper/uspr-master/ratings/Daw_jones_30/Real_prices_Alpha_vantage/daily_CVX_lookup.csv'
...
df1.to_csv(real_cvx_price_lookup)
...
# joined = pd.merge_closest(df, df1, 'timestamp', 'timestamp')
